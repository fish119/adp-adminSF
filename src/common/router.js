...
export const getRouterData = app => {
  const routerConfig = {
    ...
    '/setting/menu': {
      component: dynamicWrapper(app, ['menu'], () => import('../routes/Setting/Menu')),
    },
    '/setting/authority': {
    ...
    '/organization/user': {
      component: dynamicWrapper(app, ['user'], () => import('../routes/Organization/User')),
    },
    '/profiles/profile': {
      component: dynamicWrapper(app, ['profile'], () => import('../routes/Profile/Profile')),
    },
    '/profiles/changePassword': {
      component: dynamicWrapper(app, [], () => import('../routes/Profile/ChangePassword')),
    },
    '/article/category': {
      component: dynamicWrapper(app, ['article'], () => import('../routes/Article/Category')),
    },
    '/article/article/': {
      component: dynamicWrapper(app, ['article'], () => import('../routes/Article/Article')),
    },
    '/article/article/edit': {
      component: dynamicWrapper(app, ['article'], () => import('../routes/Article/Edit')),
    },
    '/customer/customer/': {
      component: dynamicWrapper(app, ['customer'], () => import('../routes/Customer/customer')),
    },
    '/customer/customer/edit': {
      component: dynamicWrapper(app, ['customer'], () => import('../routes/Customer/Edit')),
    },
    '/sale/sale/': {
      component: dynamicWrapper(app, ['sale'], () => import('../routes/Sale/sale')),
    },
    '/sale/sale/edit': {
      component: dynamicWrapper(app, ['customer'], () => import('../routes/Sale/Edit')),
    },
  };
